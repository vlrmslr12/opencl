...
int main(void) {
	...
	int i;
	const int LIST_SIZE = 1024*16*16;
	...
	get_time = (t2.QuadPart - t1.QuadPart) / (frequency.QuadPart / 100000);
	...
	ret = clGetKernelWorkGroupInfo(kernel, device_id, CL_KERNEL_PREFERRED_WORK_GROUP_SIZE_MULTIPLE, sizeof(local_item_size), &local_item_size, NULL);
